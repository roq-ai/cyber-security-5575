...
import { getCompanyServiceById } from 'apiSdk/company-services';
import { CompanyServiceInterface } from 'interfaces/company-service';

function CompanyServiceViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('company_service', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/company-services/edit/${id}`} passHref legacyBehavior>
                    <Button
