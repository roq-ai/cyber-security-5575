...
export function CompanyListPage(props: CompanyListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getCompanies({
        relations: ['user', 'company_service.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('company_service', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'company_service',
          header: 'Company Service',
          accessorKey: 'company_service',
          cell: ({ row: { original: record } }: any) => record?._count?.company_service,
        }
      : null,
